 ...
 */
public class AdvancedTeamInfoActivity extends UI implements TAdapterDelegate, TeamMemberAdapter.AddMemberCallback, TeamMemberAdapter.RemoveMemberCallback,
    ...
    private static final String USERINFO_CUSTOMZATION = "USERINFO_CUSTOMZATION";
    ...
    private static final int TEAM_MEMBERS_SHOW_LIMIT = 50;
...
//                    ToastHelper.showToastLong(AdvancedTeamInfoActivity.this, R.string.update_success);
                }
                break;
    ...
    private void findViews() {
        TitleBarView barView = findView(R.id.title_bar);
        barView.setLeftIcon(R.drawable.seletor_nav_btn_back)
                .showDivider(false)
        ...
        findView(R.id.tv_clear_chat).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void clearChattingHistory(final String account, final SessionTypeEnum sessionType) {
        ...
        confirmDialog.setOnClickSureListener(new CommonConfirmDialog.OnClickSureListener() {
            ...
            public void onClickSure(View view) {
                ...
                ToastHelper.showToast(AdvancedTeamInfoActivity.this, "清除成功");
            }
        });
        confirmDialog.show();
    }
    ...
    @Override
    public void onHeadImageViewClick(View v, String account) {
     ...
     */
    private void removeMember(final String account) {
        ...
        NIMClient.getService(TeamService.class).removeMember(teamId, account).setCallback(new RequestCallback<Void>() {
            ...
            @Override
            public void onFailed(int code) {
                ToastHelper.showToastLong(AdvancedTeamInfoActivity.this,
                        String.format(getString(R.string.update_failed), code));
            }
    ...
    @Override
    public void onRemoveMember(String ac) {
        ...
        option.type = ContactSelectActivity.ContactSelectType.TEAM_MEMBER;
        option.teamId = teamId;
        NimUIKit.startContactSelector(AdvancedTeamInfoActivity.this, option, REQUEST_CODE_CONTACT_SELECT_REMOVE);
    }
