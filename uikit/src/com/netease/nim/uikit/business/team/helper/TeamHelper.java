...
public class TeamHelper {
    public static final String OPEN_SHOW_NAME = "OPEN_SHOW_NAME";
    public static final String CLOSE_SHOW_NAME = "CLOSE_SHOW_NAME";
     ...
     * @return
     */
    public static ContactSelectActivity.Option getForwardSelectContactPeopleOption(ArrayList<String> memberAccounts) {
        ContactSelectActivity.Option option = new ContactSelectActivity.Option();
        option.isForWard = true;
        option.isShowSelectTeam = true;
        option.title = NimUIKit.getContext().getString(R.string.invite_member);
        option.alreadySelectedForward = memberAccounts;
        return option;
    }
     ...
     * @return
     */
    public static ContactSelectActivity.Option getForwardSelectTeamOption() {
        ContactSelectActivity.Option option = new ContactSelectActivity.Option();
        option.isForWard = true;
    ...
    public static void setShowName(String key, String value) {
        SPHelper.putString(NimUIKitImpl.getAccount() + key, value);
    }

    public static String getShowName(String key) {
        return SPHelper.getString(NimUIKitImpl.getAccount() + key, "");
    }
}
