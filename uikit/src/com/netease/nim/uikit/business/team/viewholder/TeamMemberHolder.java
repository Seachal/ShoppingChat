...
public class TeamMemberHolder extends TViewHolder {
    ...
    protected void refresh(Object item) {
        ...
        ownerImageView.setVisibility(View.GONE); //不显示群主
        ...
        if (getAdapter().getMode() == TeamMemberAdapter.Mode.NORMAL) {
            ...
            if (memberItem.getTag() == TeamMemberAdapter.TeamMemberItemTag.ADD) {
                // add team member
                headImageView.setBackgroundResource(R.drawable.seletor_chat_group_add);
                ...
                // delete team member
                headImageView.setBackgroundResource(R.drawable.selector_chat_btn_group_minus);
                nameTextView.setVisibility(View.INVISIBLE);
        ...
        headImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (teamMemberHolderEventListener != null) {
                    teamMemberHolderEventListener.onHeadImageViewClick(v, item.getAccount());
                }
            }
        });
