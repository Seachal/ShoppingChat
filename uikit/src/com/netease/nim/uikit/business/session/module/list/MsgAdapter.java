...
//            notifyDataSetChanged(); // 可以不要！！！
    ...
    public interface ViewHolderEventListener {
        ...
        void onAvatarLongClicked(Context context, View clickView, IMMessage message);
        ...
        // viewholder item 点击事件
        void onItemClick(View itemView, IMMessage message);

        // 双击
        void onItemDoubleClick(View itemView, IMMessage message);
    }
