...
public class MsgViewHolderFactory {
    ...
    public static Class<? extends MsgViewHolderBase> getViewHolderByType(IMMessage message) {
        ...
        } else if (message.getMsgType() == MsgTypeEnum.custom) { //todo 自定义消息
            MsgAttachment attachment = message.getAttachment();
            if (attachment instanceof RedPackageAttachment) { //红包消息
                return MsgViewHolderRedPackage.class;
            } else if (attachment instanceof RobRedPackageAttachment) { //红包被抢消息
                return MsgViewHolderCustomNotification.class;
            }
    ...
    public static List<Class<? extends MsgViewHolderBase>> getAllViewHolders() {
        ...
        //红包自定义消息
        list.add(MsgViewHolderRedPackage.class);
        return list;
    }
}
