...
public class ContactDataAdapter extends BaseAdapter {
    ...
    private onLoadDataFinishLisenter loadDataFinishLisenter;

    public void setLoadDataFinishLisenter(onLoadDataFinishLisenter loadDataFinishLisenter) {
        this.loadDataFinishLisenter = loadDataFinishLisenter;
    }
    ...
    public interface onLoadDataFinishLisenter {
        void loadDataFinish(AbsContactDataList datas);
    }
    ...
    private class Task extends AsyncTask<Void, Object, Void> implements Host {
        ...
        protected void onPostExecute(Void result) {
            if (loadDataFinishLisenter!=null){
                loadDataFinishLisenter.loadDataFinish(datas);
            }
            onTaskFinish(this);
        }
