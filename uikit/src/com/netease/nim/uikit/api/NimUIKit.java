...
public class NimUIKit {
    ...
    public static void init(Context context, UIKitOptions option,String account) {
        NimUIKitImpl.init(context, option);
    ...
    public static void setCommonTeamInfoClickCustomization(SessionCustomization commonP2PSessionCustomization) {
        NimUIKitImpl.setCommonTeamInfoClickCustomization(commonP2PSessionCustomization);
    }
    /**
