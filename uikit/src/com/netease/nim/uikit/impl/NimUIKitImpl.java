...
public final class NimUIKitImpl {
    ...
    // 单聊界面定制
    private static SessionCustomization commonTeamInfoClickCustomization;
    // 群聊界面定制
    ...
    private static void initDefaultSessionCustomization() {
        ...
        if (commonTeamInfoClickCustomization == null) {
            commonTeamInfoClickCustomization = new DefaultP2PSessionCustomization();
        }
    }
...
//            AdvancedTeamInfoActivity.start(context, teamId,commonTeamInfoClickCustomization); // 启动固定群资料页
            FlockDetailActivity.start(context, teamId, commonTeamInfoClickCustomization); // 启动固定群资料页
    ...
    public static Boolean isPersonAccount(int is_group) {
        if (is_group != 1) {
            return true;
        }
        return false;
    ...
    public static void setCommonTeamInfoClickCustomization(SessionCustomization commonP2PSessionCustomization) {
        NimUIKitImpl.commonTeamInfoClickCustomization = commonP2PSessionCustomization;
    }
}
