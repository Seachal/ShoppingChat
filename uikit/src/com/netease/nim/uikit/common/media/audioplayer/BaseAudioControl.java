...
abstract public class BaseAudioControl<T> {
    ...
    protected AudioControlListener mAudioControlListener;
    ...
    public void stopAudio() {
        if (state == AudioControllerState.playing) {
            ...
            if (mAudioControlListener != null) {
                mAudioControlListener.onEndPlay(currentPlayable);
            }
        }
    }
