...
import com.laka.androidlib.util.ActivityOrientationHelper;
...
public abstract class UI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityOrientationHelper.setActivityPortrait(this);
    ...
    protected void initStatusBar() {
        initStatusBar(R.color.color_ededed);
    }
    ...
    public Resources getResources() {
        ...
        if (ScreenUtils.getFontSizeScale() > 0.5) {
            config.fontScale = ScreenUtils.getFontSizeScale();//1 设置正常字体大小的倍数
        }
