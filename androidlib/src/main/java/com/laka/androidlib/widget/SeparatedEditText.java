...
public class SeparatedEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    public SeparatedEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        blockColor = ta.getColor(R.styleable.SeparatedEditText_blockColor, ContextCompat.getColor(getContext(), R.color.black));
        textColor = ta.getColor(R.styleable.SeparatedEditText_txtColor, ContextCompat.getColor(getContext(), R.color.gray_8f));
        cursorColor = ta.getColor(R.styleable.SeparatedEditText_cursorColor, ContextCompat.getColor(getContext(), R.color.color_gray));
