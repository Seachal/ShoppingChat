...
public class TitleBarView<T> extends RelativeLayout implements ICustomViewInit<T>, ITitleBarView {
    ...
    public void initViews(final Context context, @Nullable AttributeSet attrs) {
        ...
        mLlTitleLeft.setOnClickListener(new OnClickListener() {
            @Override
...
//                    + "\n输出title颜色：" + titleTextColor + "\n默认文字颜色：" + defaultTextColor);
    ...
    public ITitleBarView setLeftTextColor(int resColor) {
        this.leftTextColor = ResourceUtils.getColor(resColor);
        mTvBarLeft.setTextColor(leftTextColor);
        return this;
    }
    ...
    @Override
    public ITitleBarView setOnLeftClickListener(OnClickListener onLeftIconClickListener) {
    ...
    @Override
    public ITitleBarView setRightTextBg(int drawable) {
        mTvBarRight.setBackgroundResource(drawable);
        mTvBarRight.setVisibility(VISIBLE);
        return this;
    }
    ...
    @Override
    public ITitleBarView setOnRightClickListener(OnClickListener onRightClickListener) {
    ...
    @Override
    public ITitleBarView setDividerColor(@ColorRes int color) {
        mDivider.setBackgroundResource(color);
        return this;
    }
