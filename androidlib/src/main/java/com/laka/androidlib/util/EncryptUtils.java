...
public class EncryptUtils {
     ...
     * 用户自定义的加密方法
     * */
    public static String encryptCustomMd5ToString(String data) throws UnsupportedEncodingException {
        return new String(encryptMD5(AuthorizationInterceptor.LAKA_APP_SECRET + data + AuthorizationInterceptor.LAKA_APP_SECRET)).toLowerCase();
    }
