...
public final class ScreenUtils {
    ...
    private static float fontSizeScale = 0;
    ...
    public static float getFontSizeScale() {
        if (fontSizeScale == 0f) {
            fontSizeScale = SPHelper.getFloat(AppConstant.SP_FONTSCALE, 1.0f);
        }
        return fontSizeScale;
    }

    public static void setFontSizeScale(float fontSizeScale) {
        ScreenUtils.fontSizeScale = fontSizeScale;
    }
}
