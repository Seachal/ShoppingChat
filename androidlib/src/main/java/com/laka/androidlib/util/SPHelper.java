...
public final class SPHelper {
    ...
    private static SharedPreferences sDraftSp;
    private static final String DRAFT_FILE_NAME = "draft_file_name";

    private static SharedPreferences getDraftFile() {
        if (sDraftSp == null) {
            synchronized (SPHelper.class) {
                if (sDraftSp == null) {
                    sDraftSp = getSharedPreferences(DRAFT_FILE_NAME);
                }
            }
        }
        return sDraftSp;
    ...
    public static String getDraftString(String key, String def) {
        return getDraftFile().getString(key, def);
    }

    public static void putDraftString(String key, String value) {
        getDraftFile().edit().putString(key, value).commit();
    }

    public static void removeDraftString(String key) {
        getDraftFile().edit().remove(key).commit();
    }
