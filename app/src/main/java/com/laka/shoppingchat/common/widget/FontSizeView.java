...
public class FontSizeView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // initDefault
        defaultLineWidth = ScreenUtil.dip2px(2);
        defaultCircleRadius = ScreenUtil.dip2px(35);
        lineWidth = ScreenUtil.dip2px(1);
...
//        mTextPaint.setStrokeWidth(DensityUtils.dp2px(context, 1));
        mTextPaint.setTextSize(ScreenUtil.sp2px(smallSize));
        ...
        mText1Paint.setTextSize(ScreenUtil.sp2px(bigSize));
        ...
        mText2Paint.setTextSize(ScreenUtil.sp2px(standerSize));
