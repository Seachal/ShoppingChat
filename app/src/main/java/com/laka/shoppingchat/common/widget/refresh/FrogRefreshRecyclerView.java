...
import com.laka.androidlib.widget.refresh.CustomClassicsFooter;
import com.laka.shoppingchat.R;
import com.laka.shoppingchat.common.widget.recycler.ErGouRefreshHeader;
...
public class FrogRefreshRecyclerView extends RefreshRecycleView {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mRefreshFooter = new CustomClassicsFooter(context);
        mNoDataView = LayoutInflater.from(context).inflate(R.layout.layout_no_data, this, false);
        mNoDataButton = mNoDataView.findViewById(R.id.btn_no_data);
    ...
    private void initEvent() {
        mNoDataButton.setOnClickListener(mNoDataClickListener);
        mNoDataView.findViewById(R.id.iv_no_data).setOnClickListener(mNoDataClickListener);
        mErrorButton.setOnClickListener(mErrorClickListener);
        mErrorView.setOnClickListener(mErrorClickListener);
    }

    private View.OnClickListener mNoDataClickListener = new OnClickListener() {
        @Override
