package com.laka.shoppingchat.common.util.update
...
import com.laka.shoppingchat.mvp.main.model.repository.HomeApiRepository
...
class UpdateManager(private val mContext: Context) {
    ...
    private fun startDownload() {
        ...
        // 获取本地的文件,用于下载apk
        val mApkFile = FileUtils.getAppFile("ShoppingChat.apk", null, true)
