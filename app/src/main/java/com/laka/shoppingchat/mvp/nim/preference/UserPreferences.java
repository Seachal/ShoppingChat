package com.laka.shoppingchat.mvp.nim.preference;
...
public class UserPreferences {
    ...
    static SharedPreferences getSharedPreferences() {
        return ApplicationUtils.getContext().getSharedPreferences("Demo." + UserUtils.getImAccount(), Context.MODE_PRIVATE);
    }
}
