...
import com.laka.shoppingchat.mvp.shopping.center.view.fragment.ShoppingListFragment
...
//        tvSales?.setCompoundDrawables(null, null, null, null)
        ...
        itemView?.setTextColor(mContext.resources.getColor(R.color.color_ff4c0c))
    }
...
//                resetColor()
    ...
    private fun resetTab(textView: TextView?) {
        ...
        textView?.setTextColor(mContext.resources.getColor(R.color.color_ff4c0c))
