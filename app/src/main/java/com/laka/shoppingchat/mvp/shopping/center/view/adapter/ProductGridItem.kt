...
import com.laka.shoppingchat.common.util.SpannableStringUtils
...
import com.laka.shoppingchat.mvp.shopping.center.weight.TagLayout
...
class ProductGridItem : MultipleAdapterItem<ProductWithCoupon> {
    ...
    override fun convert(helper: BaseViewHolder, item: ProductWithCoupon?) {
        ...
        GlideLoader.loadImage(helper?.convertView?.context,
                "${item?.getSmallPic()}",
