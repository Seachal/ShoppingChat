package com.laka.shoppingchat.mvp.nim;
...
public class NimSDKOptionConfig {
    ...
    public static SDKOptions getSDKOptions(Context context) {
        ...
        if (BuildConfig.DEBUG) {//测试
            options.appKey = "9b21eb7cf801131330b949501bd1cb1e";
        } else {//正式
            options.appKey = "21b1226f2f4e511dc9a43aa8d9ff0daf";
        }
        ...
        // 通知栏显示用户昵称和头像
        options.userInfoProvider = new NimUserInfoProvider(ApplicationUtils.getContext());
    ...
    public static String getAppCacheDir(Context context) {
        ...
        if (TextUtils.isEmpty(storageRootPath)) {
            ...
            storageRootPath = Environment.getExternalStorageDirectory() + "/" + ApplicationUtils.getContext().getPackageName();
        }
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        config.notificationColor = ApplicationUtils.getContext().getResources().getColor(R.color.color_main);
        // 通知铃声的uri字符串
        ...
        // save cache，留做切换账号备用
        UserUtils.setNotificationConfig(config);
        return config;
    }
